...
import com.example.studentdailyframework.databinding.ActivityCalculateWeightHightBinding
import com.example.studentdailyframework.databinding.ActivityHadisBt1Binding

class Calculate_weight_hight : AppCompatActivity() {

    private lateinit var binding: ActivityCalculateWeightHightBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityCalculateWeightHightBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.Calback.setOnClickListener {
            startActivity(Intent(this@Calculate_weight_hight, MainActivity::class.java))
            finish()
        }
        ...
        calBtn.setOnClickListener {
            ...
            if (validateInput(weight, height)) {
                val bmi = weight.toFloat() / ((height.toFloat()
                        / 100) * (height.toFloat() / 100))
